      ...
      <div class="col s3 m3">
        ...
        <div class="sidenav center">
            ...
            <ul class="collapsible " data-collapsible="expandable">
                <li>
                    <div id="home" class="collapsible-header sidenav-item"><a>文件</a></div>
                </li>
                <li>
                    <div id="video" class="collapsible-header sidenav-item"><a>视频</a></div>
                </li>
                <li>
                    <div id="music" class="collapsible-header sidenav-item"><a>音乐</a></div>
                </li>
                <li>
                    <div id="image" class="collapsible-header sidenav-item"><a>图片</a></div>
                </li>
                <li>
                    <div id="recently" class="collapsible-header sidenav-item"><a>最近</a></div>
                </li>
                <li>
            ...
            <div class="info">
                <div class="row">
                    <div id="info" class="card-panel teal">
                        <span class="white-text">space:</span>
                        <span class="white-text">100/100</span>
                        <div class="progress">
